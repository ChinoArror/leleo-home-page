const config = {
  ...
  metaData:{
    title: 'Dog的个人主页🎉',
    description: '欢迎来到奇妙世界！',
    keywords: 'Dog,arror,个人主页,个人网站'
  },

  avatar: "/img/avatar.jpg", // 头像
  welcometitle: "Here is Dog", // 标题
  ...
  //社交按钮
  socialPlatformIcons: [
    {icon:"mdi-github",link:"https://www.github.com/arrorchino"},
    {icon:"mdi-email",link:"mailto:arror@aryuki.com"},
